...
const static float turbo_srgb_floats[256][3] = {{0.18995, 0.07176, 0.23217},
...
Vector3ub rcsop::rendering::coloring::map_turbo(double v, double vmin, double vmax) {
    if (v <= vmin) {
 ...
 * the range [vmin,vmax]
*/
Vector3ub rcsop::rendering::coloring::map_jet(double v, double vmin, double vmax) {
...
Vector3ub rcsop::rendering::coloring::map_red(double v, double vmin, double vmax) {
...
global_colormap_func rcsop::rendering::coloring::construct_colormap_function(
